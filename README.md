...
<root>
  ...
  ├── Editor
  │   ├── Lockstep.AI.BehaviourTree.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── Lockstep.AI.BehaviourTree.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── Lockstep.AI.BehaviourTree.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── Lockstep.AI.BehaviourTree.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `Lockstep.AI.BehaviourTree`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package Lockstep.AI.BehaviourTree Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/Lockstep.AI.BehaviourTree.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/Lockstep.AI.BehaviourTree.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/Lockstep.AI.BehaviourTree.Editor.Tests.asmdef`

  `Tests/Runtime/Lockstep.AI.BehaviourTree.Tests.asmdef`
...
Use the `Documentations~/Lockstep.AI.BehaviourTree.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
